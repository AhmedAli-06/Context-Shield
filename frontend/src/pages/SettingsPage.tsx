...
import {
  Copy, Check, RefreshCw, Bell, User, Key,
  Database, Globe, Server, Save,
} from "lucide-react";
...
// → 0.87`;
  ...
  const statusBadge = (status: string) => {
    switch (status) {
      case "operational": return { label: "Connected", cls: "allow", dot: "var(--accent-green)" };
      case "degraded": return { label: "Degraded", cls: "warning", dot: "var(--accent-yellow)" };
      case "down": return { label: "Down", cls: "denied", dot: "var(--accent-red)" };
      case "checking": return { label: "Checking...", cls: "low", dot: "var(--stone)" };
      default: return { label: "Unknown", cls: "low", dot: "var(--stone)" };
    }
  };
    ...
    <motion.div variants={stagger} initial="hidden" animate="visible">
      ...
      <div className="grid-2">
        <div>
          <motion.div variants={item} style={{ marginBottom: "var(--space-xxl)" }}>
            <div className="settings-section">
              <h3><User size={14} style={{ marginRight: 8 }} /> Profile</h3>
              ...
              <div className="card-body">
                <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
                  ...
                  <div>
                    ...
                    <p style={{ fontSize: "11px", color: "var(--ash)", fontFamily: "var(--font-mono)" }}>
          ...
          <motion.div variants={item} style={{ marginBottom: "var(--space-xxl)" }}>
            <div className="settings-section">
              <h3><Bell size={14} style={{ marginRight: 8 }} /> Notifications</h3>
            ...
            <div className="card">
              <div className="card-body" style={{ padding: "var(--space-lg) var(--space-xl)" }}>
                ...
                <div className="settings-row">
                  ...
                  <Toggle active={anomalyAlerts} onChange={() => setAnomalyAlerts(!anomalyAlerts)} />
                </div>
                <div className="settings-row">
                  <div className="settings-row-info">
        ...
        <div>
          <motion.div variants={item} style={{ marginBottom: "var(--space-xxl)" }}>
            <div className="settings-section">
              <h3><Key size={14} style={{ marginRight: 8 }} /> API Access</h3>
            ...
            <div className="card" style={{ marginBottom: "var(--space-xl)" }}>
              ...
              <div className="card-body" style={{ padding: 0 }}>
                <div className="code-window" style={{ border: "none", borderRadius: 0 }}>
                  <div className="code-window-header" style={{ borderBottom: "1px solid var(--hairline)" }}>
          ...
          <motion.div variants={item}>
            <div className="settings-section">
              <h3><Server size={14} style={{ marginRight: 8 }} /> System Status</h3>
            ...
            <div className="card">
              <div className="card-body" style={{ padding: "var(--space-lg) var(--space-xl)" }}>
                <div className="settings-row">
                  <div className="settings-row-info">
                    <h4><Globe size={13} style={{ marginRight: 6, color: "var(--stone)" }} /> Version</h4>
                    <p>Current platform version</p>
                  </div>
                  <span style={{ fontSize: "12px", fontFamily: "var(--font-mono)", color: "var(--charcoal)" }}>
                    v0.2.0-alpha
                  </span>
                </div>
                <div className="settings-row">
                  <div className="settings-row-info">
                    <h4><Globe size={13} style={{ marginRight: 6, color: "var(--stone)" }} /> API Server</h4>
                ...
                <div className="settings-row">
                  <div className="settings-row-info">
                    <h4><Database size={13} style={{ marginRight: 6, color: "var(--stone)" }} /> PostgreSQL</h4>
                ...
                <div className="settings-row">
                  <div className="settings-row-info">
                    <h4><Database size={13} style={{ marginRight: 6, color: "var(--stone)" }} /> Redis</h4>
