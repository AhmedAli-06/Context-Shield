      ...
      <div className="grid-2">
        <motion.div variants={item}>
          <div className="card">
            <div className="card-header">
              <h3>
                <Download size={14} style={{ marginRight: 8 }} /> Export Events
              </h3>
            </div>
          ...
          <div className="card" style={{ marginTop: 'var(--space-xl)' }}>
            <div className="card-header">
              <h3>
                <BarChart3 size={14} style={{ marginRight: 8 }} /> Event Summary
              </h3>
            </div>
            <div className="card-body">
              <div style={{ display: 'flex', gap: '16px', alignItems: 'center' }}>
                ...
                <div>
                  <div style={{ fontSize: '13px', color: 'var(--charcoal)', fontWeight: 500 }}>
                    Quick count
                  </div>
                  <div style={{ fontSize: '12px', color: 'var(--stone)' }}>
                    {eventCount !== null
                      ? `${eventCount} events in current range`
                      : 'Click to count events'}
                  </div>
                </div>
                <button
        ...
        <motion.div variants={item}>
          <div className="card">
            <div className="card-header">
              <h3>
                <Calendar size={14} style={{ marginRight: 8 }} /> Scheduled Reports
              </h3>
            </div>
            <div className="card-body">
          ...
          <div className="card" style={{ marginTop: 'var(--space-xl)' }}>
            ...
            <div className="card-body" style={{ padding: 0 }}>
              <div style={{ padding: 'var(--space-xl)', textAlign: 'center' }}>
                <Download
                  size={24}
                  style={{ color: 'var(--stone)', opacity: 0.4, marginBottom: '8px' }}
                />
