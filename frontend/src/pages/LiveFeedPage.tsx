      ...
      <motion.div className="page-header" variants={item}>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            ...
            <span
              style={{ fontSize: '12px', color: 'var(--stone)', fontFamily: 'var(--font-mono)' }}
            >
      ...
      <motion.div className="stats-grid" variants={item}>
        ...
        <div className="stat-card">
          <div
            className="stat-glow"
            style={{
              background: connected ? 'var(--accent-green-glow)' : 'var(--accent-red-glow)',
            }}
          />
      ...
      <motion.div className="card" variants={item}>
        <div className="card-header">
          <h3>
            <Zap
              size={14}
              style={{ marginRight: 8, color: connected ? 'var(--accent-green)' : 'var(--stone)' }}
            />{' '}
            Event Stream
          </h3>
        ...
        <div className="live-feed" ref={listRef}>
          {filtered.length === 0 ? (
            <EmptyState
              ...
              description={
                connected
                  ? 'Events will appear here in real-time as they stream from the server.'
                    ...
                    <div className="live-event-meta">
                      <div className="trust-score">
                        ...
                        <span
                          ...
                          style={{ color: trustColor(ev.trust_score), fontSize: '11px' }}
                        >
